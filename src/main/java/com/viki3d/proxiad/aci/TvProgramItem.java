...
public class TvProgramItem implements Comparable<TvProgramItem> {
  ...
  public int compareTo(TvProgramItem o) {
    ...
    // Since we have this statement in the task definition: "Consider that no item can span through
    // more than one day (like starts before midnight and ends next day)." leads to find a solution
    // without using date-time approaches.
